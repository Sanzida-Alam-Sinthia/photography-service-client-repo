...
const MyReviews = () => {
    ...
    useEffect(() => {
        fetch(`https://photography-assignment-server-alpha.vercel.app/reviews?email=${user?.email}`)
            .then(res => res.json())
    ...
    const handleReviewDelete = id => {
        ...
        if (proceed) {
            fetch(`https://photography-assignment-server-alpha.vercel.app/reviews/${id}`, {
                method: 'DELETE'
            })
                .then(res => res.json())
                .then(data => {
